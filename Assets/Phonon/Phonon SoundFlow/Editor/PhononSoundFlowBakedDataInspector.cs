...
namespace Phonon
{
    ...
    [CustomEditor(typeof(PhononSoundFlowBakedData))]
    public class PhononSoundFlowBakedDataInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var data = serializedObject.targetObject as PhononSoundFlowBakedData;
            var dataSize = (data == null || data.Data == null) ? 0 : data.Data.Length;

            PhononGUI.SectionHeader("Baked Data Statistics");
            if (dataSize < 1024)
