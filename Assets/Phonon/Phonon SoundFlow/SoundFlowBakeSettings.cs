...
namespace Phonon
{
    ...
    public class SoundFlowBakeSettings : MonoBehaviour
    {

        public SoundFlowBakeSettingsPreset Preset;
        public SoundFlowBakeSettingsValue Value;

        public bool BakeReflection = true;
        public bool BakeDiffraction = true;
