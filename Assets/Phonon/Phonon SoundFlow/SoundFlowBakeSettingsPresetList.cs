...
namespace Phonon
{
    ...
    public static class SoundFlowBakeSettingsPresetList
    {
        ...
        {
            var numPresets = 4;
            values = new SoundFlowBakeSettingsValue[numPresets];

            values[0] = new SoundFlowBakeSettingsValue(1024, 1);
            values[1] = new SoundFlowBakeSettingsValue(4096, 2);
            values[2] = new SoundFlowBakeSettingsValue(16384, 4);
            values[3] = new SoundFlowBakeSettingsValue();
        }

        public static SoundFlowBakeSettingsValue PresetValue(int index)
        {
            if (!IsInitialized())
                Initialize();
        ...
        static SoundFlowBakeSettingsValue[] values;
