...
[AddComponentMenu("Phonon/Phonon SoundFlow Baked Data")]
public class PhononSoundFlowBakedData : MonoBehaviour
{
	public void SaveBakedSoundFlow(IntPtr baker)
	{
		int dataSize = Phonon.SoundFlow.iplSaveSoundFlow(baker, null);
		Data = new byte[dataSize];
		Phonon.SoundFlow.iplSaveSoundFlow(baker, Data);
	}

	public void LoadBakedSoundFlow(ref IntPtr baker, Vector3[] sources, IntPtr scene, IntPtr grid)
	{
		...
		Phonon.SoundFlow.iplLoadSoundFlow(scene, grid, settings, sources.Length, sources, Data, ref baker);
	}
