...
namespace Phonon
{
    ...
    public static class SoundFlowGlobalSettings
    {

        public static GameObject GetObject()
        {
            var name = "Phonon SoundFlow Settings";
            ...
            if (settingsObject == null)
            {
                ...
                if (existingObject == null)
                {
                    ...
                    existingObject.AddComponent<SoundFlowBakeSettings>();

                    var settingsComponent = existingObject.GetComponent<SoundFlowBakeSettings>();
                    settingsComponent.Preset = SoundFlowBakeSettingsPreset.Low;
                    settingsComponent.Value = new SoundFlowBakeSettingsValue();
                    settingsComponent.Value.Rays = SoundFlowBakeSettingsPresetList.PresetValue(0).Rays;
                    settingsComponent.Value.Bounces = SoundFlowBakeSettingsPresetList.PresetValue(0).Bounces;
                }
        ...
        public static SoundFlowBakeSettings GetBakeSettings()
        {
            return GetObject().GetComponent<SoundFlowBakeSettings>();
        }
